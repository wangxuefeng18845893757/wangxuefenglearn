...
<div id="OSC_Banner">
	...
	<div id="portrait"><a href="blog/index"><img src="images/portrait.gif" alt="Johnny" title="Johnny" class="SmallPortrait" user="154693" align="absmiddle"></a></div>
    <div id="lnks">
...
<div class="Blog">
  ...
  <div class="BlogTitle">
    ...
    <div class="BlogStat">
		<span class="admin">
			<a href="blog/newBlog">编辑</a>&nbsp;|&nbsp;<a href="javascript:delete_blog(24026)">删除</a>
		</span>
				发表于<?php echo $blogs->ADD_TIME?>, 
		已有<strong><?php echo $blogs->CLICK_RATE?></strong>次阅读  
		共<strong><a href="#comments"><?php echo $blogs->COMM_RATE?></a></strong>个评论
  ...
  <div class="BlogContent TextContent"><?php echo $blogs->CONTENT?></div>
    ...
    <h2><a name="comments" href="#postform" class="opts">发表评论»</a>共有 <?php echo $blogs->COMM_RATE?>条网友评论</h2>
			<ul id="BlogComments">
  ...
  <div class="CommentForm">
    <a name="postform"></a>
    <form id="form_comment" action="comment/add_comment?blog_id=<?php echo $blogs->BLOG_ID?>" method="POST">          
