...
<form id="CatalogForm" action="catalog/do_blogCatalog" method="post">
    <h3> 添加博客分类 </h3>
...
<table cellpadding="1" cellspacing="1">
	...
	?>
			<tr id="catalog_92334">
				...
				<td class="name"><a href="editCatalog.htm" title="点击修改博客分类"><?php echo $catas->NAME;?></a></td>
				<td class="num"><?php echo $catas->BLOG_COUNT;?></td>
				<td class="opts">
					<a href="catalog/editCatalog?catalog_id=<?php echo $catas->CATALOG_ID?>" title="点击修改博客分类">修改</a>
					<a href="catalog/deleteCatalog?catalog_id=<?php echo $catas->CATALOG_ID?>" onclick="return delete_catalog(154693,92334);">删除</a>
				</td>
			</tr>
	<?php
		}
