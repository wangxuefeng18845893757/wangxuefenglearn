...
<form id="CatalogForm" action="catalog/do_editCatalog?catalog_id=<?php foreach($cata as $catas){echo $catas->CATALOG_ID;}?>" method="post">
    <h3> 修改博客分类 </h3>
    <div id="error_msg" class="error_msg" style="display:none;"></div>
    <label>分类名称:</label><input id="txt_link_name" name="name" value="<?php foreach($cata as $catas){echo $catas->NAME;}?>" size="15" tabindex="1" type="text">
